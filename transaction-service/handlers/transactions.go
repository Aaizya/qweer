...
func RenderCreateTransactionPage(w http.ResponseWriter, r *http.Request) {
    tmpl, err := template.ParseFiles("transaction-service/templates/create_transaction.html")
    if err != nil {
        http.Error(w, err.Error(), http.StatusInternalServerError)
        return
    }
...
func RenderPayTransactionPage(w http.ResponseWriter, r *http.Request) {
    ...
    tmpl, err := template.ParseFiles("transaction-service/templates/pay_transaction.html")
    if err != nil {
        http.Error(w, err.Error(), http.StatusInternalServerError)
        return
    }
